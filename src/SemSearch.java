...
public class SemSearch {
     ...
     * @return True if the parsing and execution of operations         from the
     *     file were successful,         False if the file was not found or if
     *     an exception occurred         during parsing.
     * @throws Exception
     *     If any unexpected errors occur during the             parsing
     *     process.
     */
                ...
                switch (operation) {
                    ...
                    case "search":
                        ...
                        switch (searchType) {
                            ...
                            case "cost":
                                world.searchSeminarCost(scanner);
                                break;

                            case "date":
                                world.searchSeminarDate(scanner);
                                break;
                        }
                        break;
