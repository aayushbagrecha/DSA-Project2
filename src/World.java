...
class World {
    ...
    public void addAndInsertSeminar(
        ...
        CostBST costBST,
        DateBST dateBST,
        KeywordsBST keywordsBST) throws Exception {
        ...
        if (idBST.insertSeminar(id, seminar)) {
            // inert only once when the insertBST is successful
     ...
     *     The scanner used to read the            seminar ID for searching.
     */
    public void searchSeminarCost(Scanner scanner) {
     ...
     *     The scanner used to read the            seminar ID for searching.
     */
    public void searchSeminarDate(Scanner scanner) {
        int date1 = Integer.parseInt(scanner.next().trim());
        int date2 = Integer.parseInt(scanner.next().trim());
     ...
     *
     * @param bst
     *     The Binary Search Tree (BST)            containing seminars ordered
     *     by ID.
     */
